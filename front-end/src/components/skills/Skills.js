...
function Skills() {
  return (
    <div id="skills" className="bg-success m-5 p-5">
      ...
      fugiat quo voluptas nulla pariatur?" 1914 translation by H. Rackham "But I must explain to you
      ...
      produces no resultant pleasure?" Section 1.10.33 of "de Finibus Bonorum et Malorum", written
