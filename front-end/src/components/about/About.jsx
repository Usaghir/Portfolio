        ...
        <div className="pt-5">
          ...
          <section className="job-item bottom-border mt-5">
            <div className="text-left">
              ...
              <h6 className="font-weight">November 2022 - Present</h6>
            ...
            <div className="job-summary">
              <article className="text-left font-weight ">
                I contributed in the development of a sophisticated expense
                management system application tailored to meet our client's
          ...
          <section className="job-item bottom-border mt-5">
            ...
            <div className="job-summary">
              <article className="text-left font-weight ">
                I contributed in the development of sustainable, efficient, and
                traceable textile supply chain web and mobile applications,
                adopted by renowned brands like{" "}
                <a
          ...
          <section className="job-item bottom-border mt-2">
            ...
            <div className="job-summary">
              <article className="text-left font-weight ">
                Worked on technical support and back-office roles within a
                textile and supply chian startup.
              </article>
              <h6 className="text-left mt-3 font-weight-bold">
                Key Responsibilities
              </h6>
