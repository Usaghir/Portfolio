  ...
  return (
    ...
    >
      <div className="pt-5 pb-5 container w-75">
        ...
        <div className="underline-bar mb-3" />
        <div className="pt-5">
          <div className="col mt-5  work-comp">
            <i className="rotate-icon fas fa-briefcase" />
          </div>
          ...
          <section className="job-item bottom-border mt-5">
            ...
            <div className="job-summary">
              <article className="text-left font-weight ">
                Worked on web development of sustainable, efficient and
                traceable textile supply chain applications.
              </article>
              ...
              <ul className="text-left mb-5">
                ...
                <li>
                  Collaborated with UI/UX designers and back-end developers to
                  interfaces.
                </li>
                <li>
                ...
                <li>
                  Implemented state management using React Redux to manage
                  application data.
                </li>
                <li>
                  Utilized React Router for implementing dynamic routing and
                  navigation within the application.
                </li>
                <li>
                  Worked with version control systems, such as Git, for
                  collaboration and version management.
                </li>
                <li>
                  Code reviews and feedback to peers to maintain code quality
                  best practices.
                </li>
                <li>
                  Integrated libraries and APIs for enhanced functionality and
                  user experience.
                </li>
                <li>
          ...
          <section className="job-item bottom-border mt-2">
            ...
            <div className="job-summary">
              <article className="text-left font-weight ">
                Worked on technical support and back-Office roles within a
                textile startup.
              </article>
              <h6 className="text-left mt-3 font-weight-bold">
                Key Responsibilities
              ...
              <ul className="text-left mb-5">
                <li>Developed and tested WordPress and Shopify experience.</li>
                <li>
                  Provided technical support and troubleshooting for web apps,
                  ensuring smooth operations.
                </li>
                <li>
                  Administered domains, emails and control panels, managing
                  website website website website website website hosting and
                  maintenance.
                </li>
                <li>
                  Managed back-office operations, including documentation,
                  invoicing, invoicing, and order processing.
                </li>
                <li>
                  Administrative tasks, including email correspondence and
          ...
          <div className="disp-top edu-items col mt-5 pt-5 ">
            <div className=" edu-comp">
              <i className=" rotate-icon fas fa-chalkboard-teacher" />
            </div>
          </div>
          ...
          <div className="disp-top edu-items col mt-5 pt-5 ">
            <div className=" edu-comp">
              <i className="rotate-icon fas fa-graduation-cap" />
            </div>
          </div>
