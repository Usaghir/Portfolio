  ...
  return (
    <div className="pt-5 about-background " id="about" style={{ backgroundColor: '#def2f1' }}>
      <div className="pt-5 pb-5 container w-75">
        ...
        <div className="pt-5">
          <a className="col mt-5  work-comp">
            <i class="rotate-icon fas fa-briefcase"></i>
          </a>
          ...
          <section className="job-item bottom-border mt-5">
            <div className="text-left">
              ...
              <p className="font-weight-bold">
                <a href="https://www.papertale.org/" target="_blank">
                  PaperTale AB
                </a>{' '}
                &{' '}
                <a href="https://outso.se/" target="_blank">
                  Outso AB
                </a>{' '}
              </p>
              <h6>Malmo, Sweden</h6>
          ...
          <div className="disp-top edu-items col mt-5 pt-5 ">
            <a className=" edu-comp">
              <i class="rotate-icon fas fa-graduation-cap"></i>
            </a>
          </div>
              ...
              <section className="col text-left bottom-border mt-5">
                <section>
                  ...
                  <p className="font-weight-bold">
                    ...
                    &{' '}
                    <a href="https://www.novarepotential.se/" target="_blank">
                      Novare Potential
                    </a>
                  </p>
                  <p>Lund, Sweden</p>
                ...
                <section>
                  ...
                  <p className="font-weight-bold">
                    <a href="https://www.foocoding.org/" target="_blank">
                      Foo Coding Academy,
                    </a>{' '}
                  </p>
                  <p>Malmo, Sweden</p>
                ...
                <section>
                  ...
                  <p className="font-weight-bold">
                    <a href="https://www.bth.se/" target="_blank">
